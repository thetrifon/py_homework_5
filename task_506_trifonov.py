...
#опять беды с кодировкой, получилось по-английски,
# еще беды с тем, чтобы программа сама определила где цирфы.
# В итоге менял дизайн файла: Слова английские, указания вида деятельности и прочерки - удалены
